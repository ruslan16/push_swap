...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/09 21:26:38 by sirvin            #+#    #+#             */
/*   Updated: 2020/08/09 21:32:13 by sirvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			work_with_one(t_dupstruct *f, int count_stacs,
					int j, int size_stacs);
void			work_with_sixstac(t_dupstruct *f, int i, int j, int size_stacs);
void			work_with_elevenstac(t_dupstruct *f, int i,
							int j, int size_stacs);
